...
if __name__ == "__main__":
    ...
    model = DynamicModel([input_size, hidden_size, output_size], act_function)
    ...
    # Train the model
    te_dfa, loss_dfa, angles = train(model, X_train, y_train, n_epochs=2, lr=1e-4, batch_size=200, tol = 1e-4)
    ...
    while inp != "q":
        ...
        a1, h1, a2, pred = forward_pass(model, X)
